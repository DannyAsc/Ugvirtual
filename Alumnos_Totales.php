...
$query_libros_consulta = "SELECT * FROM alumno";
...
<html>
  ...
  <p><b>DETALLES DE ALUMNOS REGISTRADOS</b></p>
<table>
  <tr>
    <td>Clave Alumno
    <td>Nombre Alumno
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_libros_consulta['clave_alumno']; ?>&nbsp; </td>
      <td><a href="Detalles_Alumnos.php?recordID=<?php echo $row_libros_consulta['clave_alumno']; ?>">
       <?php echo $row_libros_consulta['nombre_alumno']; ?>&nbsp; </a></td>
