...
$queryPrimeraTabla = mysql_query("SELECT * from alumno where nombre_alumno='".$_POST['buscar']."';");
...
echo "<tr><td>ID</td><td>Nombre</td><td>Contrasena</td></tr>";
while( $resultado = mysql_fetch_array($queryPrimeraTabla) ){
echo "<tr><td>";
echo $resultado['clave_alumno'];
echo "<td></td>";
echo $resultado['nombre_alumno']; 
echo "<td></td>";
echo $resultado['contrasena_alumno']; 
}
echo "</table>";
